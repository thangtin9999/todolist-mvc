...
<div>
    ...
    <div class="custom-control custom-checkbox" id="div-task-<?php echo $row['id']; ?>">
        ...
        <?php } else { ?>
        <div class="custom-control custom-checkbox" id="div-task-<?php echo $row['id']; ?>">
            <input id="defaultChecked<?php echo $row['id']; ?> " type="checkbox" class="custom-control-input" checked
                disabled>
            <label class="custom-control-label" for="defaultChecked<?php echo $row['id']; ?> ">
                <span class="label-text" style="text-decoration: line-through;" id="text<?php echo $row['id']; ?>">
                    <?php echo $row['content'];
                            ?></span>

            </label>
            <span class="badge pull-right">
                <button id="edit" name="edit" class="btn btn-danger" value="<?php echo $row['id']; ?>"
                    data-toggle="modal" data-target="#basicExampleModal"><i class="fa fa-pencil" aria-hidden="true"></i>
                </button>
                <button id="delete" name="delete" class="btn btn-danger" value="<?php echo $row['id']; ?>"><i
                        class="fa fa-trash-o" aria-hidden="true"></i>
                </button>
